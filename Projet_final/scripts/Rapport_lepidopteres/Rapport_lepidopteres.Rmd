...
```{r fig1, fig.cap="Variation des latitudes du territoire de quatre espèces de lépidoptères (Cercyonis pegala, Colias philodice, Pieris rapae et Poanes hobomok) par période de 20 ans de 1860 à 2020.", fig.pos="H", echo=FALSE, out.width="80%", fig.align='center', message = FALSE, warning = FALSE}
...
```{r fig2,fig.cap=" Variation du nombre d’espèces de lépidoptères observées selon les années",fig.pos = "H", echo=FALSE, out.width="80%", fig.align='center', message = FALSE, warning = FALSE}

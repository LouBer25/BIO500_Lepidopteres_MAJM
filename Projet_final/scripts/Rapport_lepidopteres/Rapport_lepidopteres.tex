...
{\centering \includegraphics[width=0.8\linewidth]{./scripts/Rapport_lepidopteres/graphique_latitude} 
...
{\centering \includegraphics[width=0.8\linewidth]{./scripts/Rapport_lepidopteres/graphique_richesse} 
...
{\centering \includegraphics[width=0.8\linewidth]{./scripts/Rapport_lepidopteres/graphique_carte} 

...
creer_observation <- 
	"CREATE TABLE observation (
		...
		FOREIGN KEY (coordonnee) REFERENCES coordonnee(lat)
	);"
...
#13) Requête SQL pour vérifier le fonctionnement de l'injection de données dans les tables

test <- dbGetQuery(observation,

...
![Figure 1 : Variation des latitudes du territoire de quatre espèces de lépidoptères (Cercyonis pegala, Colias philodice, Pieris rapae et Poanes hobomok) par période de 20 ans de 1860 à 2020. ](images/Figure1.png){width=50% height=40%}
...
![Figure 2 : Variation du nombre d’espèces de lépidoptères observées selon les années](images/Figure2.png){width=50% height=40%}
...
![Figure 3 : Distribution de la richesse spécifique des lépidoptères au Québec en 2020](images/Figure3.png){width=50% height=40%}

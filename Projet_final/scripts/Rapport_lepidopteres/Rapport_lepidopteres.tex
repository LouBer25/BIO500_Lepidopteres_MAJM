...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,height=0.4\textheight]{images/Figure1.png}
\caption{Figure 1 : Variation des latitudes du territoire de quatre
espèces de lépidoptères (Cercyonis pegala, Colias philodice, Pieris
rapae et Poanes hobomok) par période de 20 ans de 1860 à 2020.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,height=0.4\textheight]{images/Figure2.png}
\caption{Figure 2 : Variation du nombre d'espèces de lépidoptères
observées selon les années}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,height=0.4\textheight]{images/Figure3.png}
\caption{Figure 3 : Distribution de la richesse spécifique des
lépidoptères au Québec en 2020}
\end{figure}

...
Figure 1 : Variation des latitudes du territoire de quatre espèces de lépidoptères (Cercyonis pegala, Colias philodice, Pieris rapae et Poanes hobomok) par période de 20 ans de 1860 à 2020. 
Dans la Figure 1, il est possible d’observer que Cercyonis pegala est l’espèce où les latitudes de son territoire ont le plus varier entre 2000 et 2020. De plus, on remarque que, pour les quatre espèces, les latitudes entre 2000 et 2020 ont augmenté vers le nord. Colias philodice est la seule espèce avec une grande variation dans les latitudes de son territoire dans les années 1880. 
 
Figure 2 : Variation du nombre d’espèces de lépidoptères observées selon les années
...
Figure 3 : Distribution de la richesse spécifique des lépidoptères au Québec en 2020
